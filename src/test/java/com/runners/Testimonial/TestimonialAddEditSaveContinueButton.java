package com.runners.Testimonial;
...
public class TestimonialAddEditSaveContinueButton {
	@CucumberOptions(features = { "src/test/resources/com/features" }, glue = { "com.stepdifinations", "com.runners" },
			tags={"@TestimonialAddSaveContinue or @TestimonialEditSaveContinue or TestimonialDelete"},
//			tags={"@blogAdd"},
